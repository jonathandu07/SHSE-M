...
from frontend.pieces.sketches_2d import circuit_refroidissement

class TestCircuitRefroidissement2D(unittest.TestCase):
    def test_draw(self):
        fig, ax = plt.subplots()
        ...
        circuit_refroidissement.draw(ax, piece)
