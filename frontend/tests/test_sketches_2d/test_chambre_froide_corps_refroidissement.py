...
from frontend.pieces.sketches_2d import chambre_froide_corps_refroidissement

class TestChambreFroideCorpsRefroidissement2D(unittest.TestCase):
    def test_draw(self):
        fig, ax = plt.subplots()
        ...
        chambre_froide_corps_refroidissement.draw(ax, piece)
