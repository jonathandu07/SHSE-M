...
from frontend.pieces.sketches_2d import jaquette_refroidissement_enveloppe_eau

class TestJaquetteRefroidissementEnveloppeEau2D(unittest.TestCase):
    def test_draw(self):
        fig, ax = plt.subplots()
        ...
        jaquette_refroidissement_enveloppe_eau.draw(ax, piece)
