...
from frontend.pieces.sketches_2d import contrepoids_equilibrage

class TestContrepoidsEquilibrage2D(unittest.TestCase):
    def test_draw(self):
        fig, ax = plt.subplots()
        ...
        contrepoids_equilibrage.draw(ax, piece)
