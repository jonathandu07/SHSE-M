...
from frontend.pieces.sketches_2d import roulements_bagues_galet

class TestRoulementsBaguesGalet2D(unittest.TestCase):
    def test_draw(self):
        fig, ax = plt.subplots()
        ...
        roulements_bagues_galet.draw(ax, piece)
