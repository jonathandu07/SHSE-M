...
from frontend.pieces.sketches_2d import rail_glissiere_translation_galet

class TestRailGlissiereTranslationGalet2D(unittest.TestCase):
    def test_draw(self):
        fig, ax = plt.subplots()
        ...
        rail_glissiere_translation_galet.draw(ax, piece)
