...
from frontend.pieces.sketches_2d import etancheite_paroi_mobile_joints_guide_labyrinthe_segments

class TestEtancheiteParoiMobileJointsGuideLabyrintheSegments2D(unittest.TestCase):
    def test_draw(self):
        fig, ax = plt.subplots()
        ...
        etancheite_paroi_mobile_joints_guide_labyrinthe_segments.draw(ax, piece)
