...
from frontend.pieces.sketches_2d import isolation_thermique_externe

class TestIsolationThermiqueExterne2D(unittest.TestCase):
    def test_draw(self):
        fig, ax = plt.subplots()
        ...
        isolation_thermique_externe.draw(ax, piece)
