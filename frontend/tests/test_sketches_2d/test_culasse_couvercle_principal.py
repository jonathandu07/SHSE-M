...
from frontend.pieces.sketches_2d import culasse_couvercle_principal

class TestCulasseCouverclePrincipal2D(unittest.TestCase):
    def test_draw(self):
        fig, ax = plt.subplots()
        ...
        culasse_couvercle_principal.draw(ax, piece)
