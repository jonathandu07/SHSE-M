...
from frontend.pieces.sketches_2d import joint_tournant_arbre_sortie

class TestJointTournantArbreSortie2D(unittest.TestCase):
    def test_draw(self):
        fig, ax = plt.subplots()
        ...
        joint_tournant_arbre_sortie.draw(ax, piece)
