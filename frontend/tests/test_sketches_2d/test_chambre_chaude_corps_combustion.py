...
from frontend.pieces.sketches_2d import chambre_chaude_corps_combustion

class TestChambreChaudeCorpsCombustion2D(unittest.TestCase):
    def test_draw(self):
        fig, ax = plt.subplots()
        ...
        chambre_chaude_corps_combustion.draw(ax, piece)
