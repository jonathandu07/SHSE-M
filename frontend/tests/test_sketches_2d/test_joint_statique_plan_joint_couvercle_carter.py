...
from frontend.pieces.sketches_2d import joint_statique_plan_joint_couvercle_carter

class TestJointStatiquePlanJointCouvercleCarter2D(unittest.TestCase):
    def test_draw(self):
        fig, ax = plt.subplots()
        ...
        joint_statique_plan_joint_couvercle_carter.draw(ax, piece)
