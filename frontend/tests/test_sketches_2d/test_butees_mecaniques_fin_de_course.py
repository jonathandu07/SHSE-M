...
from frontend.pieces.sketches_2d import butees_mecaniques_fin_de_course

class TestButeesMecaniquesFinDeCourse2D(unittest.TestCase):
    def test_draw(self):
        fig, ax = plt.subplots()
        ...
        butees_mecaniques_fin_de_course.draw(ax, piece)
