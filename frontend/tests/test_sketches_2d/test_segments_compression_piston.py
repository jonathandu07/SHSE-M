...
from frontend.pieces.sketches_2d import segments_compression_piston

class TestSegmentsCompressionPiston2D(unittest.TestCase):
    def test_draw(self):
        fig, ax = plt.subplots()
        ...
        segments_compression_piston.draw(ax, piece)
