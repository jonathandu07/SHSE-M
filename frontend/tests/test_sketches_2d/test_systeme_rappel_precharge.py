...
from frontend.pieces.sketches_2d import systeme_rappel_precharge

class TestSystemeRappelPrecharge2D(unittest.TestCase):
    def test_draw(self):
        fig, ax = plt.subplots()
        ...
        systeme_rappel_precharge.draw(ax, piece)
