...
from frontend.pieces.sketches_2d import echangeur_thermique_corps

class TestEchangeurThermiqueCorps2D(unittest.TestCase):
    def test_draw(self):
        fig, ax = plt.subplots()
        ...
        echangeur_thermique_corps.draw(ax, piece)
