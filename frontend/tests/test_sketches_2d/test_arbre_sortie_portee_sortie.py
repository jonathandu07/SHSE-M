...
from frontend.pieces.sketches_2d import arbre_sortie_portee_sortie

class TestArbreSortiePorteeSortie2D(unittest.TestCase):
    def test_draw(self):
        fig, ax = plt.subplots()
        ...
        arbre_sortie_portee_sortie.draw(ax, piece)
