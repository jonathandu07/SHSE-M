...
from frontend.pieces.sketches_2d import tubes_helicoidaux_serpentins_cote_gaz

class TestTubesHelicoidauxSerpentinsCoteGaz2D(unittest.TestCase):
    def test_draw(self):
        fig, ax = plt.subplots()
        ...
        tubes_helicoidaux_serpentins_cote_gaz.draw(ax, piece)
