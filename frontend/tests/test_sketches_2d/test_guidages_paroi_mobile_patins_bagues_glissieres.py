...
from frontend.pieces.sketches_2d import guidages_paroi_mobile_patins_bagues_glissieres

class TestGuidagesParoiMobilePatinsBaguesGlissieres2D(unittest.TestCase):
    def test_draw(self):
        fig, ax = plt.subplots()
        ...
        guidages_paroi_mobile_patins_bagues_glissieres.draw(ax, piece)
