...
from frontend.pieces.sketches_2d import joints_statiques_collecteurs_gaz

class TestJointsStatiquesCollecteursGaz2D(unittest.TestCase):
    def test_draw(self):
        fig, ax = plt.subplots()
        ...
        joints_statiques_collecteurs_gaz.draw(ax, piece)
