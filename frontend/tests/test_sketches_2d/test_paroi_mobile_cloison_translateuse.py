...
from frontend.pieces.sketches_2d import paroi_mobile_cloison_translateuse

class TestParoiMobileCloisonTranslateuse2D(unittest.TestCase):
    def test_draw(self):
        fig, ax = plt.subplots()
        ...
        paroi_mobile_cloison_translateuse.draw(ax, piece)
