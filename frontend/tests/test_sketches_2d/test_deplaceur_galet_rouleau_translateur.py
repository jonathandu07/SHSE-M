...
from frontend.pieces.sketches_2d import deplaceur_galet_rouleau_translateur

class TestDeplaceurGaletRouleauTranslateur2D(unittest.TestCase):
    def test_draw(self):
        fig, ax = plt.subplots()
        ...
        deplaceur_galet_rouleau_translateur.draw(ax, piece)
