...
But :
    Orchestrer la visualisation frontend de la piece deplaceur.
...
def afficher_vues_deplaceur(*, data: Mapping[str, Any] | None = None, global_report: Mapping[str, Any] | None = None, run_demo: bool = False) -> Dict[str, Any]:
...
if __name__ == "__main__":
    afficher_vues_deplaceur(run_demo=True)
