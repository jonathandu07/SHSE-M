...
But : Page d'affichage (orchestrateur) pour la pièce deplaceur, utilisant frontend/main.py pour extraire les données.
"""
...
def afficher_vues_deplaceur():
    ...
    print("Affichage des modules graphiques pour la pièce : deplaceur")
