"""
Chemin : frontend/components/moteur_thermique/pieces/deplaceur/deplaceur.py
But : Page d'affichage (orchestrateur) pour la pièce deplaceur.
"""
...
try:
    ...
    print("Avertissement : Impossible d'importer la classe Deplaceur du backend.")
...
def afficher_vues_deplaceur():
    print("=======================================================")
    print("  Affichage des vues pour : deplaceur")
    print("=======================================================")
    ...
    try:
        ...
        print(f"Erreur lors de l'instanciation de Deplaceur : {e}")
        return
