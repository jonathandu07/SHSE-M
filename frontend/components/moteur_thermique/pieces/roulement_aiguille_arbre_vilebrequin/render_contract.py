"""
Chemin : frontend/components/moteur_thermique/pieces/roulement_aiguille_arbre_vilebrequin/render_contract.py
But :
    Fournir le contrat de rendu commun de la piece roulement_aiguille_arbre_vilebrequin.
