...
But :
    Orchestrer la visualisation frontend de la piece roulement_aiguille_arbre_vilebrequin.
...
PIECE_NAME = "roulement_aiguille_arbre_vilebrequin"
TITLE = "Roulement Aiguille Arbre Vilebrequin"
...
def afficher_vues_roulement_aiguille_arbre_vilebrequin(*, data: Mapping[str, Any] | None = None, global_report: Mapping[str, Any] | None = None, run_demo: bool = False) -> Dict[str, Any]:
...
if __name__ == "__main__":
    afficher_vues_roulement_aiguille_arbre_vilebrequin(run_demo=True)
