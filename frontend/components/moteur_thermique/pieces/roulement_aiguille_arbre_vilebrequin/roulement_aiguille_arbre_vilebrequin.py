...
But : Page d'affichage (orchestrateur) pour la pièce roulement_aiguille_arbre_vilebrequin.
"""
...
try:
    ...
    print("Avertissement : Impossible d'importer la classe RoulementAiguilleArbreVilebrequin du backend.")
...
def afficher_vues_roulement_aiguille_arbre_vilebrequin():
    print("=======================================================")
    print("  Affichage des vues pour : roulement_aiguille_arbre_vilebrequin")
    print("=======================================================")
    ...
    try:
        piece = RoulementAiguilleArbreVilebrequin()
    except Exception as e:
        print(f"Erreur lors de l'instanciation de RoulementAiguilleArbreVilebrequin : {e}")
        return
