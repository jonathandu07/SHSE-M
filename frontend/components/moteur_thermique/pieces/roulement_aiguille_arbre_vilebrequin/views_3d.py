"""
Chemin : frontend/components/moteur_thermique/pieces/roulement_aiguille_arbre_vilebrequin/views_3d.py
But :
    Produire la vue 3D indicative de la piece roulement_aiguille_arbre_vilebrequin.
