"""
Chemin : frontend/components/moteur_thermique/pieces/roulement_aiguille_arbre_vilebrequin/charts.py
But :
    Exposer les graphiques backend de comportement pour la piece roulement_aiguille_arbre_vilebrequin.
