"""
Chemin : frontend/components/moteur_thermique/pieces/roulement_aiguille_arbre_vilebrequin/data_adapter.py
But :
    Adapter les donnees backend de la piece roulement_aiguille_arbre_vilebrequin.
