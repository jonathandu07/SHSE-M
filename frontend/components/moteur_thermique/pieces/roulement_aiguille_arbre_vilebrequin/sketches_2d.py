...
But :
    Produire le contrat de croquis 2D cote de la piece roulement_aiguille_arbre_vilebrequin.
...
def tracer_croquis_roulement_aiguille_arbre_vilebrequin_2d(data: Mapping[str, Any] | None = None, global_report: Mapping[str, Any] | None = None) -> Any:
    return tracer_croquis(data=data, global_report=global_report)
