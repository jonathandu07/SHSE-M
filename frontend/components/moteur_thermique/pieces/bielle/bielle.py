...
But : Page d'affichage (orchestrateur) pour la pièce bielle.
"""
...
try:
    from backend.components.moteur_thermique.pieces.bielle import Bielle
    HAS_BACKEND_CLASS = True
except ImportError:
    HAS_BACKEND_CLASS = False
    print("Avertissement : Impossible d'importer la classe Bielle du backend.")
...
def afficher_vues_bielle():
    print("=======================================================")
    print("  Affichage des vues pour : bielle")
    print("=======================================================")
    ...
    try:
        ...
        print(f"Erreur lors de l'instanciation de Bielle : {e}")
        return
