"""
Chemin : frontend/components/moteur_thermique/pieces/joint_deplaceur/joint_deplaceur.py
But : Page d'affichage (orchestrateur) pour la pièce joint_deplaceur.
"""
...
try:
    ...
    print("Avertissement : Impossible d'importer la classe JointDeplaceur du backend.")
...
def afficher_vues_joint_deplaceur():
    print("=======================================================")
    print("  Affichage des vues pour : joint_deplaceur")
    print("=======================================================")
    ...
    try:
        piece = JointDeplaceur()
    except Exception as e:
        print(f"Erreur lors de l'instanciation de JointDeplaceur : {e}")
        return
