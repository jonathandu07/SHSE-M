...
But :
    Orchestrer la visualisation frontend de la piece joint_deplaceur.
...
PIECE_NAME = "joint_deplaceur"
TITLE = "Joint Deplaceur"
...
def afficher_vues_joint_deplaceur(*, data: Mapping[str, Any] | None = None, global_report: Mapping[str, Any] | None = None, run_demo: bool = False) -> Dict[str, Any]:
...
if __name__ == "__main__":
    afficher_vues_joint_deplaceur(run_demo=True)
