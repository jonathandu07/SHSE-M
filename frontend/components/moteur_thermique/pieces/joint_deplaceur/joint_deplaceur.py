...
But : Page d'affichage (orchestrateur) pour la pièce joint_deplaceur, utilisant frontend/main.py pour extraire les données.
"""
...
def afficher_vues_joint_deplaceur():
    ...
    print("Affichage des modules graphiques pour la pièce : joint_deplaceur")
