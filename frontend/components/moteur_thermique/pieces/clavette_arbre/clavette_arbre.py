...
But : Page d'affichage (orchestrateur) pour la pièce clavette_arbre, utilisant frontend/main.py pour extraire les données.
"""
...
def afficher_vues_clavette_arbre():
    ...
    print("Affichage des modules graphiques pour la pièce : clavette_arbre")
