"""
Chemin : frontend/components/moteur_thermique/pieces/clavette_arbre/clavette_arbre.py
But : Page d'affichage (orchestrateur) pour la pièce clavette_arbre.
"""
...
try:
    ...
    print("Avertissement : Impossible d'importer la classe ClavetteArbre du backend.")
...
def afficher_vues_clavette_arbre():
    print("=======================================================")
    print("  Affichage des vues pour : clavette_arbre")
    print("=======================================================")
    ...
    try:
        ...
        print(f"Erreur lors de l'instanciation de ClavetteArbre : {e}")
        return
