...
But :
    Orchestrer la visualisation frontend de la piece clavette_arbre.
...
PIECE_NAME = "clavette_arbre"
TITLE = "Clavette Arbre"
...
def afficher_vues_clavette_arbre(*, data: Mapping[str, Any] | None = None, global_report: Mapping[str, Any] | None = None, run_demo: bool = False) -> Dict[str, Any]:
...
if __name__ == "__main__":
    afficher_vues_clavette_arbre(run_demo=True)
