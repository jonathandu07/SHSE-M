"""
Chemin : frontend/components/moteur_thermique/pieces/coussinet_arbre_piston/render_contract.py
But :
    Fournir le contrat de rendu commun de la piece coussinet_arbre_piston.
