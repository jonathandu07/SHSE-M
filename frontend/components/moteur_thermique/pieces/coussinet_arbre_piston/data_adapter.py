"""
Chemin : frontend/components/moteur_thermique/pieces/coussinet_arbre_piston/data_adapter.py
But :
    Adapter les donnees backend de la piece coussinet_arbre_piston.
