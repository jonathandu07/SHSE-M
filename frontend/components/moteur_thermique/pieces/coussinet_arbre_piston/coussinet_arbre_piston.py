...
But : Page d'affichage (orchestrateur) pour la pièce coussinet_arbre_piston, utilisant frontend/main.py pour extraire les données.
"""
...
def afficher_vues_coussinet_arbre_piston():
    ...
    print("Affichage des modules graphiques pour la pièce : coussinet_arbre_piston")
