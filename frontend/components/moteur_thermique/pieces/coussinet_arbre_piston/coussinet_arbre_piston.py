"""
Chemin : frontend/components/moteur_thermique/pieces/coussinet_arbre_piston/coussinet_arbre_piston.py
But : Page d'affichage (orchestrateur) pour la pièce coussinet_arbre_piston.
"""
...
try:
    ...
    print("Avertissement : Impossible d'importer la classe CoussinetArbrePiston du backend.")
...
def afficher_vues_coussinet_arbre_piston():
    print("=======================================================")
    print("  Affichage des vues pour : coussinet_arbre_piston")
    print("=======================================================")
    ...
    try:
        piece = CoussinetArbrePiston()
    except Exception as e:
        print(f"Erreur lors de l'instanciation de CoussinetArbrePiston : {e}")
        return
...
if __name__ == "__main__":
    afficher_vues_coussinet_arbre_piston()
