...
But : Page d'affichage (orchestrateur) pour la pièce arbre_piston.
"""
...
try:
    ...
    print("Avertissement : Impossible d'importer la classe ArbrePiston du backend.")
...
def afficher_vues_arbre_piston():
    print("=======================================================")
    print("  Affichage des vues pour : arbre_piston")
    print("=======================================================")
    ...
    try:
        ...
        print(f"Erreur lors de l'instanciation de ArbrePiston : {e}")
        return
