...
But : Page d'affichage (orchestrateur) pour la pièce arbre_piston, utilisant frontend/main.py pour extraire les données.
"""
...
def afficher_vues_arbre_piston():
    ...
    print("Affichage des modules graphiques pour la pièce : arbre_piston")
