"""
Chemin : frontend/components/moteur_thermique/pieces/vis_couvercle_cylindre/vis_couvercle_cylindre.py
But : Page d'affichage (orchestrateur) pour la pièce vis_couvercle_cylindre.
"""
...
try:
    ...
    print("Avertissement : Impossible d'importer la classe VisCouvercleCylindre du backend.")
...
def afficher_vues_vis_couvercle_cylindre():
    print("=======================================================")
    print("  Affichage des vues pour : vis_couvercle_cylindre")
    print("=======================================================")
    ...
    try:
        piece = VisCouvercleCylindre()
    except Exception as e:
        print(f"Erreur lors de l'instanciation de VisCouvercleCylindre : {e}")
        return
...
if __name__ == "__main__":
    afficher_vues_vis_couvercle_cylindre()
