...
But : Page d'affichage (orchestrateur) pour la pièce vis_couvercle_cylindre, utilisant frontend/main.py pour extraire les données.
"""
...
def afficher_vues_vis_couvercle_cylindre():
    ...
    print("Affichage des modules graphiques pour la pièce : vis_couvercle_cylindre")
