...
# frontend/components/moteur_thermique/pieces/vis_couvercle_cylindre/sketches_2d.py
from __future__ import annotations

import matplotlib.pyplot as plt
from backend.components.moteur_thermique.pieces.vis_couvercle_cylindre import VisCouvercleCylindre

def tracer_vue_cote(ax, piece: VisCouvercleCylindre):
...
def tracer_vue_face(ax, piece: VisCouvercleCylindre):
...
def afficher_2d(piece: VisCouvercleCylindre):
