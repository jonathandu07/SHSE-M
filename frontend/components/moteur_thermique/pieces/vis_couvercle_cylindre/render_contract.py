"""
Chemin : frontend/components/moteur_thermique/pieces/vis_couvercle_cylindre/render_contract.py
But :
    Fournir le contrat de rendu commun de la piece vis_couvercle_cylindre.
