"""
Chemin : frontend/components/moteur_thermique/pieces/vis_couvercle_cylindre/data_adapter.py
But :
    Adapter les donnees backend de la piece vis_couvercle_cylindre.
