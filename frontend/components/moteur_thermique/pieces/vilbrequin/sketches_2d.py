"""
Chemin : frontend/components/moteur_thermique/pieces/vilbrequin/sketches_2d.py
But :
    Produire le contrat de croquis 2D cote de la piece vilbrequin.
...
def tracer_croquis_vilbrequin_2d(data: Mapping[str, Any] | None = None, global_report: Mapping[str, Any] | None = None) -> Any:
    return tracer_croquis(data=data, global_report=global_report)
