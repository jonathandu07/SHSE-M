...
But : Page d'affichage (orchestrateur) pour la pièce vilbrequin, utilisant frontend/main.py pour extraire les données.
"""
...
def afficher_vues_vilbrequin():
    ...
    print("Affichage des modules graphiques pour la pièce : vilbrequin")
