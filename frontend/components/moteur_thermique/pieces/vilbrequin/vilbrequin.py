"""
Chemin : frontend/components/moteur_thermique/pieces/vilbrequin/vilbrequin.py
But : Page d'affichage (orchestrateur) pour la pièce vilbrequin.
"""
...
try:
    ...
    print("Avertissement : Impossible d'importer la classe Vilbrequin du backend.")
...
def afficher_vues_vilbrequin():
    print("=======================================================")
    print("  Affichage des vues pour : vilbrequin")
    print("=======================================================")
    ...
    try:
        ...
        print(f"Erreur lors de l'instanciation de Vilbrequin : {e}")
        return
