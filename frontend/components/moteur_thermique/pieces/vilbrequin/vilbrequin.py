...
But :
    Orchestrer la visualisation frontend de la piece vilbrequin.
...
def afficher_vues_vilbrequin(*, data: Mapping[str, Any] | None = None, global_report: Mapping[str, Any] | None = None, run_demo: bool = False) -> Dict[str, Any]:
...
if __name__ == "__main__":
    afficher_vues_vilbrequin(run_demo=True)
