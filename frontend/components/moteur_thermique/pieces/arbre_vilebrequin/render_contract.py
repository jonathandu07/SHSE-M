"""
Chemin : frontend/components/moteur_thermique/pieces/arbre_vilebrequin/render_contract.py
But :
    Fournir le contrat de rendu commun de la piece arbre_vilebrequin.
