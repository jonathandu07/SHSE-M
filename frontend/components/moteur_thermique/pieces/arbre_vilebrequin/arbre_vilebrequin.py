"""
Chemin : frontend/components/moteur_thermique/pieces/arbre_vilebrequin/arbre_vilebrequin.py
But : Page d'affichage (orchestrateur) pour la pièce arbre_vilebrequin.
"""
...
try:
    from backend.components.moteur_thermique.pieces.arbre_vilebrequin import ArbreVilebrequin
    HAS_BACKEND_CLASS = True
except ImportError:
    HAS_BACKEND_CLASS = False
    print("Avertissement : Impossible d'importer la classe ArbreVilebrequin du backend.")
...
def afficher_vues_arbre_vilebrequin():
    print("=======================================================")
    print("  Affichage des vues pour : arbre_vilebrequin")
    print("=======================================================")
    ...
    try:
        piece = ArbreVilebrequin()
    except Exception as e:
        print(f"Erreur lors de l'instanciation de ArbreVilebrequin : {e}")
        return
...
if __name__ == "__main__":
    afficher_vues_arbre_vilebrequin()
