"""
Chemin : frontend/components/moteur_thermique/pieces/arbre_vilebrequin/charts.py
But :
    Exposer les graphiques backend de comportement pour la piece arbre_vilebrequin.
