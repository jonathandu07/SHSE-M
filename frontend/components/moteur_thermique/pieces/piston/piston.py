...
But : Page d'affichage (orchestrateur) pour la pièce piston, utilisant frontend/main.py pour extraire les données.
"""
...
def afficher_vues_piston():
    ...
    print("Affichage des modules graphiques pour la pièce : piston")
