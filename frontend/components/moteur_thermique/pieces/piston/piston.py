"""
Chemin : frontend/components/moteur_thermique/pieces/piston/piston.py
But : Page d'affichage (orchestrateur) pour la pièce piston.
"""
...
try:
    ...
    print("Avertissement : Impossible d'importer la classe Piston du backend.")
...
def afficher_vues_piston():
    print("=======================================================")
    print("  Affichage des vues pour : piston")
    print("=======================================================")
    ...
    try:
        ...
        print(f"Erreur lors de l'instanciation de Piston : {e}")
        return
