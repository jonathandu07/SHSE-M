...
But :
    Orchestrer la visualisation frontend de la piece piston.
...
def afficher_vues_piston(*, data: Mapping[str, Any] | None = None, global_report: Mapping[str, Any] | None = None, run_demo: bool = False) -> Dict[str, Any]:
...
if __name__ == "__main__":
    afficher_vues_piston(run_demo=True)
