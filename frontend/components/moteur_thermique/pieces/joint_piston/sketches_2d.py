"""
Chemin : frontend/components/moteur_thermique/pieces/joint_piston/sketches_2d.py
But :
    Produire le contrat de croquis 2D cote de la piece joint_piston.
...
def tracer_croquis_joint_piston_2d(data: Mapping[str, Any] | None = None, global_report: Mapping[str, Any] | None = None) -> Any:
    return tracer_croquis(data=data, global_report=global_report)
