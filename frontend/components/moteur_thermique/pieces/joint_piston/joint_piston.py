...
But : Page d'affichage (orchestrateur) pour la pièce joint_piston, utilisant frontend/main.py pour extraire les données.
"""
...
def afficher_vues_joint_piston():
    ...
    print("Affichage des modules graphiques pour la pièce : joint_piston")
