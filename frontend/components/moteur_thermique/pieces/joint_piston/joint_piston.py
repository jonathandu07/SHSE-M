"""
Chemin : frontend/components/moteur_thermique/pieces/joint_piston/joint_piston.py
But : Page d'affichage (orchestrateur) pour la pièce joint_piston.
"""
...
try:
    ...
    print("Avertissement : Impossible d'importer la classe JointPiston du backend.")
...
def afficher_vues_joint_piston():
    print("=======================================================")
    print("  Affichage des vues pour : joint_piston")
    print("=======================================================")
    ...
    try:
        ...
        print(f"Erreur lors de l'instanciation de JointPiston : {e}")
        return
