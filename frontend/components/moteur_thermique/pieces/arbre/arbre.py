...
But : Page d'affichage (orchestrateur) pour la pièce arbre, utilisant frontend/main.py pour extraire les données.
"""
...
def afficher_vues_arbre():
    ...
    print("Affichage des modules graphiques pour la pièce : arbre")
