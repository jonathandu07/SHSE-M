"""
Chemin : frontend/components/moteur_thermique/pieces/arbre/arbre.py
But : Page d'affichage (orchestrateur) pour la pièce arbre.
"""
...
try:
    from backend.components.moteur_thermique.pieces.arbre import Arbre
    HAS_BACKEND_CLASS = True
except ImportError:
    HAS_BACKEND_CLASS = False
    print("Avertissement : Impossible d'importer la classe Arbre du backend.")
...
def afficher_vues_arbre():
    print("=======================================================")
    print("  Affichage des vues pour : arbre")
    print("=======================================================")
    ...
    try:
        ...
        print(f"Erreur lors de l'instanciation de Arbre : {e}")
        return
