"""
Chemin : frontend/components/moteur_thermique/pieces/arbre_vilbrequin/sketches_2d.py
But : Définition des esquisses géométriques 2D de la pièce.
"""

# frontend/components/moteur_thermique/pieces/arbre_vilbrequin/sketches_2d.py
from __future__ import annotations

import matplotlib.pyplot as plt
from backend.components.moteur_thermique.pieces.arbre_vilbrequin import ArbreVilbrequin

def tracer_vue_cote(ax, piece: ArbreVilbrequin):
...
def tracer_vue_face(ax, piece: ArbreVilbrequin):
...
def afficher_2d(piece: ArbreVilbrequin):
