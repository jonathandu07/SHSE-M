...
But : Page d'affichage (orchestrateur) pour la pièce arbre_vilbrequin, utilisant frontend/main.py pour extraire les données.
"""
...
def afficher_vues_arbre_vilbrequin():
    ...
    print("Affichage des modules graphiques pour la pièce : arbre_vilbrequin")
