...
But : Page d'affichage (orchestrateur) pour la pièce arbre_vilbrequin.
"""
...
try:
    ...
    print("Avertissement : Impossible d'importer la classe ArbreVilbrequin du backend.")
...
def afficher_vues_arbre_vilbrequin():
    print("=======================================================")
    print("  Affichage des vues pour : arbre_vilbrequin")
    print("=======================================================")
    ...
    try:
        piece = ArbreVilbrequin()
    except Exception as e:
        print(f"Erreur lors de l'instanciation de ArbreVilbrequin : {e}")
        return
...
if __name__ == "__main__":
    afficher_vues_arbre_vilbrequin()
