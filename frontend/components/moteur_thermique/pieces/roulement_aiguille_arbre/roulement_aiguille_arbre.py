...
But : Page d'affichage (orchestrateur) pour la pièce roulement_aiguille_arbre, utilisant frontend/main.py pour extraire les données.
"""
...
def afficher_vues_roulement_aiguille_arbre():
    ...
    print("Affichage des modules graphiques pour la pièce : roulement_aiguille_arbre")
