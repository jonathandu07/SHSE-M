"""
Chemin : frontend/components/moteur_thermique/pieces/roulement_aiguille_arbre/roulement_aiguille_arbre.py
But : Page d'affichage (orchestrateur) pour la pièce roulement_aiguille_arbre.
"""
...
try:
    ...
    print("Avertissement : Impossible d'importer la classe RoulementAiguilleArbre du backend.")
...
def afficher_vues_roulement_aiguille_arbre():
    print("=======================================================")
    print("  Affichage des vues pour : roulement_aiguille_arbre")
    print("=======================================================")
    ...
    try:
        piece = RoulementAiguilleArbre()
    except Exception as e:
        print(f"Erreur lors de l'instanciation de RoulementAiguilleArbre : {e}")
        return
...
if __name__ == "__main__":
    afficher_vues_roulement_aiguille_arbre()
