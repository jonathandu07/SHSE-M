...
But :
    Orchestrer la visualisation frontend de la piece roulement_aiguille_arbre.
...
PIECE_NAME = "roulement_aiguille_arbre"
TITLE = "Roulement Aiguille Arbre"
...
def afficher_vues_roulement_aiguille_arbre(*, data: Mapping[str, Any] | None = None, global_report: Mapping[str, Any] | None = None, run_demo: bool = False) -> Dict[str, Any]:
...
if __name__ == "__main__":
    afficher_vues_roulement_aiguille_arbre(run_demo=True)
