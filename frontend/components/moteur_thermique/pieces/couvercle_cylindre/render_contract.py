"""
Chemin : frontend/components/moteur_thermique/pieces/couvercle_cylindre/render_contract.py
But :
    Fournir le contrat de rendu commun de la piece couvercle_cylindre.
