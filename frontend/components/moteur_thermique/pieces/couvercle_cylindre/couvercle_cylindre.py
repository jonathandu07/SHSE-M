...
But :
    Orchestrer la visualisation frontend de la piece couvercle_cylindre.
...
PIECE_NAME = "couvercle_cylindre"
TITLE = "Couvercle Cylindre"
...
def afficher_vues_couvercle_cylindre(*, data: Mapping[str, Any] | None = None, global_report: Mapping[str, Any] | None = None, run_demo: bool = False) -> Dict[str, Any]:
...
if __name__ == "__main__":
    afficher_vues_couvercle_cylindre(run_demo=True)
