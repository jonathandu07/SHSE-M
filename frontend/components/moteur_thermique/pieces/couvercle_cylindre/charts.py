"""
Chemin : frontend/components/moteur_thermique/pieces/couvercle_cylindre/charts.py
But :
    Exposer les graphiques backend de comportement pour la piece couvercle_cylindre.
