...
But :
    Produire le contrat de croquis 2D cote de la piece cylindre.
...
def tracer_croquis_cylindre_2d(data: Mapping[str, Any] | None = None, global_report: Mapping[str, Any] | None = None) -> Any:
    return tracer_croquis(data=data, global_report=global_report)
