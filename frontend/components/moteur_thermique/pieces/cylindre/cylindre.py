...
But : Page d'affichage (orchestrateur) pour la pièce cylindre, utilisant frontend/main.py pour extraire les données.
"""
...
def afficher_vues_cylindre():
    ...
    print("Affichage des modules graphiques pour la pièce : cylindre")
