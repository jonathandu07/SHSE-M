"""
Chemin : frontend/components/moteur_thermique/pieces/cylindre/cylindre.py
But : Page d'affichage (orchestrateur) pour la pièce cylindre.
"""
...
try:
    ...
    print("Avertissement : Impossible d'importer la classe Cylindre du backend.")
...
def afficher_vues_cylindre():
    print("=======================================================")
    print("  Affichage des vues pour : cylindre")
    print("=======================================================")
    ...
    try:
        ...
        print(f"Erreur lors de l'instanciation de Cylindre : {e}")
        return
