...
But : Page d'affichage (orchestrateur) pour la pièce rotor_moteur_electrique.
"""
...
try:
    ...
    print("Avertissement : Impossible d'importer la classe RotorMoteurElectrique du backend.")
...
def afficher_vues_rotor_moteur_electrique():
    print("=======================================================")
    print("  Affichage des vues pour : rotor_moteur_electrique")
    print("=======================================================")
    ...
    try:
        piece = RotorMoteurElectrique()
    except Exception as e:
        print(f"Erreur lors de l'instanciation de RotorMoteurElectrique : {e}")
        return
