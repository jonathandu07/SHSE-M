...
But :
    Orchestrer la visualisation frontend de la piece rotor_moteur_electrique.
...
def afficher_vues_rotor_moteur_electrique(*, data: Mapping[str, Any] | None = None, global_report: Mapping[str, Any] | None = None, run_demo: bool = False) -> Dict[str, Any]:
...
if __name__ == "__main__":
    afficher_vues_rotor_moteur_electrique(run_demo=True)
