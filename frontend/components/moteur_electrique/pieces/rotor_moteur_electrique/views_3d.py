"""
Chemin : frontend/components/moteur_electrique/pieces/rotor_moteur_electrique/views_3d.py
But :
    Produire la vue 3D indicative de la piece rotor_moteur_electrique.
