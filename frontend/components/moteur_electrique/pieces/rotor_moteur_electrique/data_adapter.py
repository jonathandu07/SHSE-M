"""
Chemin : frontend/components/moteur_electrique/pieces/rotor_moteur_electrique/data_adapter.py
But :
    Adapter les donnees backend de la piece rotor_moteur_electrique.
