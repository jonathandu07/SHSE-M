"""
Chemin : frontend/components/moteur_electrique/pieces/stator_moteur_electrique/sketches_2d.py
But :
    Produire le contrat de croquis 2D cote de la piece stator_moteur_electrique.
...
def tracer_croquis_stator_moteur_electrique_2d(data: Mapping[str, Any] | None = None, global_report: Mapping[str, Any] | None = None) -> Any:
    return tracer_croquis(data=data, global_report=global_report)
