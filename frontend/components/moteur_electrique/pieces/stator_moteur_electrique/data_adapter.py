"""
Chemin : frontend/components/moteur_electrique/pieces/stator_moteur_electrique/data_adapter.py
But :
    Adapter les donnees backend de la piece stator_moteur_electrique.
