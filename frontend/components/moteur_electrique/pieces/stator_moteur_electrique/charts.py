"""
Chemin : frontend/components/moteur_electrique/pieces/stator_moteur_electrique/charts.py
But : Génération des graphiques et visualisations de données pour la pièce.
"""

# frontend/components/moteur_electrique/pieces/stator_moteur_electrique/charts.py
...
def afficher_radar(piece: StatorMoteurElectrique):
