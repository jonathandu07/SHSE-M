"""
Chemin : frontend/components/moteur_electrique/pieces/stator_moteur_electrique/render_contract.py
But :
    Fournir le contrat de rendu commun de la piece stator_moteur_electrique.
