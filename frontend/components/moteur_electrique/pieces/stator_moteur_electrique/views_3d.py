"""
Chemin : frontend/components/moteur_electrique/pieces/stator_moteur_electrique/views_3d.py
But :
    Produire la vue 3D indicative de la piece stator_moteur_electrique.
