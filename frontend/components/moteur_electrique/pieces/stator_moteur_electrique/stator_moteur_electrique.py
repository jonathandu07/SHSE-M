...
But : Page d'affichage (orchestrateur) pour la pièce stator_moteur_electrique, utilisant frontend/main.py pour extraire les données.
"""
...
def afficher_vues_stator_moteur_electrique():
    ...
    print("Affichage des modules graphiques pour la pièce : stator_moteur_electrique")
