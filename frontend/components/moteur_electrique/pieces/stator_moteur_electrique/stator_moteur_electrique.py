"""
Chemin : frontend/components/moteur_electrique/pieces/stator_moteur_electrique/stator_moteur_electrique.py
But : Page d'affichage (orchestrateur) pour la pièce stator_moteur_electrique.
"""
...
try:
    ...
    print("Avertissement : Impossible d'importer la classe StatorMoteurElectrique du backend.")
...
def afficher_vues_stator_moteur_electrique():
    print("=======================================================")
    print("  Affichage des vues pour : stator_moteur_electrique")
    print("=======================================================")
    ...
    try:
        piece = StatorMoteurElectrique()
    except Exception as e:
        print(f"Erreur lors de l'instanciation de StatorMoteurElectrique : {e}")
        return
...
if __name__ == "__main__":
    afficher_vues_stator_moteur_electrique()
