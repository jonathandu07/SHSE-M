...
But :
    Orchestrer la visualisation frontend de la piece stator_moteur_electrique.
...
PIECE_NAME = "stator_moteur_electrique"
TITLE = "Stator Moteur Electrique"
...
def afficher_vues_stator_moteur_electrique(*, data: Mapping[str, Any] | None = None, global_report: Mapping[str, Any] | None = None, run_demo: bool = False) -> Dict[str, Any]:
...
if __name__ == "__main__":
    afficher_vues_stator_moteur_electrique(run_demo=True)
