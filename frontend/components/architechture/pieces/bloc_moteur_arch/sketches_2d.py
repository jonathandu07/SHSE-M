...
# frontend/components/architechture/pieces/bloc_moteur_arch/sketches_2d.py
from __future__ import annotations

import matplotlib.pyplot as plt
from backend.components.architechture.pieces.bloc_moteur_arch import BlocMoteurArch

def tracer_vue_cote(ax, piece: BlocMoteurArch):
...
def tracer_vue_face(ax, piece: BlocMoteurArch):
...
def afficher_2d(piece: BlocMoteurArch):
