"""
Chemin : frontend/components/architechture/pieces/bloc_moteur_arch/bloc_moteur_arch.py
But : Page d'affichage (orchestrateur) pour la pièce bloc_moteur_arch.
"""
...
try:
    ...
    print("Avertissement : Impossible d'importer la classe BlocMoteurArch du backend.")
...
def afficher_vues_bloc_moteur_arch():
    print("=======================================================")
    print("  Affichage des vues pour : bloc_moteur_arch")
    print("=======================================================")
    ...
    try:
        piece = BlocMoteurArch()
    except Exception as e:
        print(f"Erreur lors de l'instanciation de BlocMoteurArch : {e}")
        return
...
if __name__ == "__main__":
    afficher_vues_bloc_moteur_arch()
