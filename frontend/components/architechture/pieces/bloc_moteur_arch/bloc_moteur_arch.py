...
But : Page d'affichage (orchestrateur) pour la pièce bloc_moteur_arch, utilisant frontend/main.py pour extraire les données.
"""
...
def afficher_vues_bloc_moteur_arch():
    ...
    print("Affichage des modules graphiques pour la pièce : bloc_moteur_arch")
