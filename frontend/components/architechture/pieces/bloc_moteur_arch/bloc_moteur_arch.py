...
But :
    Orchestrer la visualisation frontend de la piece bloc_moteur_arch.
...
PIECE_NAME = "bloc_moteur_arch"
TITLE = "Bloc Moteur Arch"
...
def afficher_vues_bloc_moteur_arch(*, data: Mapping[str, Any] | None = None, global_report: Mapping[str, Any] | None = None, run_demo: bool = False) -> Dict[str, Any]:
...
if __name__ == "__main__":
    afficher_vues_bloc_moteur_arch(run_demo=True)
