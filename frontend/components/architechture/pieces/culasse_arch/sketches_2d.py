...
# frontend/components/architechture/pieces/culasse_arch/sketches_2d.py
from __future__ import annotations

import matplotlib.pyplot as plt
from backend.components.architechture.pieces.culasse_arch import CulasseArch

def tracer_vue_cote(ax, piece: CulasseArch):
...
def tracer_vue_face(ax, piece: CulasseArch):
...
def afficher_2d(piece: CulasseArch):
