...
But : Page d'affichage (orchestrateur) pour la pièce culasse_arch, utilisant frontend/main.py pour extraire les données.
"""
...
def afficher_vues_culasse_arch():
    ...
    print("Affichage des modules graphiques pour la pièce : culasse_arch")
