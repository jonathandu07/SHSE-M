"""
Chemin : frontend/components/architechture/pieces/culasse_arch/culasse_arch.py
But : Page d'affichage (orchestrateur) pour la pièce culasse_arch.
"""
...
try:
    ...
    print("Avertissement : Impossible d'importer la classe CulasseArch du backend.")
...
def afficher_vues_culasse_arch():
    print("=======================================================")
    print("  Affichage des vues pour : culasse_arch")
    print("=======================================================")
    ...
    try:
        ...
        print(f"Erreur lors de l'instanciation de CulasseArch : {e}")
        return
