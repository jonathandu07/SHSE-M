"""
Chemin : frontend/components/architechture/pieces/vilebrequin_arch/sketches_2d.py
But :
    Produire le contrat de croquis 2D cote de la piece vilebrequin_arch.
...
def tracer_croquis_vilebrequin_arch_2d(data: Mapping[str, Any] | None = None, global_report: Mapping[str, Any] | None = None) -> Any:
    return tracer_croquis(data=data, global_report=global_report)
