...
# frontend/components/architechture/pieces/vilebrequin_arch/sketches_2d.py
from __future__ import annotations

import matplotlib.pyplot as plt
from backend.components.architechture.pieces.vilebrequin_arch import VilebrequinArch

def tracer_vue_cote(ax, piece: VilebrequinArch):
...
def tracer_vue_face(ax, piece: VilebrequinArch):
...
def afficher_2d(piece: VilebrequinArch):
