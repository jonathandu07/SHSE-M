"""
Chemin : frontend/components/architechture/pieces/vilebrequin_arch/charts.py
But :
    Exposer les graphiques backend de comportement pour la piece vilebrequin_arch.
