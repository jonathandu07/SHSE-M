...
But :
    Orchestrer la visualisation frontend de la piece vilebrequin_arch.
...
PIECE_NAME = "vilebrequin_arch"
TITLE = "Vilebrequin Arch"
...
def afficher_vues_vilebrequin_arch(*, data: Mapping[str, Any] | None = None, global_report: Mapping[str, Any] | None = None, run_demo: bool = False) -> Dict[str, Any]:
...
if __name__ == "__main__":
    afficher_vues_vilebrequin_arch(run_demo=True)
