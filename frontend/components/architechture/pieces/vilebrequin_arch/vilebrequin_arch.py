...
But : Page d'affichage (orchestrateur) pour la pièce vilebrequin_arch, utilisant frontend/main.py pour extraire les données.
"""
...
def afficher_vues_vilebrequin_arch():
    ...
    print("Affichage des modules graphiques pour la pièce : vilebrequin_arch")
