"""
Chemin : frontend/components/architechture/pieces/vilebrequin_arch/vilebrequin_arch.py
But : Page d'affichage (orchestrateur) pour la pièce vilebrequin_arch.
"""
...
try:
    ...
    print("Avertissement : Impossible d'importer la classe VilebrequinArch du backend.")
...
def afficher_vues_vilebrequin_arch():
    print("=======================================================")
    print("  Affichage des vues pour : vilebrequin_arch")
    print("=======================================================")
    ...
    try:
        piece = VilebrequinArch()
    except Exception as e:
        print(f"Erreur lors de l'instanciation de VilebrequinArch : {e}")
        return
...
if __name__ == "__main__":
    afficher_vues_vilebrequin_arch()
