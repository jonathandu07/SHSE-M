"""
Chemin : frontend/components/batterie/pieces/pack_batterie/sketches_2d.py
But : Définition des esquisses géométriques 2D de la pièce.
"""

# frontend/components/batterie/pieces/pack_batterie/sketches_2d.py
from __future__ import annotations

import matplotlib.pyplot as plt
from backend.components.batterie.pieces.pack_batterie import PackBatterie

def tracer_vue_cote(ax, piece: PackBatterie):
...
def tracer_vue_face(ax, piece: PackBatterie):
...
def afficher_2d(piece: PackBatterie):
