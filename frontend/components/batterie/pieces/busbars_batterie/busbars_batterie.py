...
But :
    Orchestrer la visualisation frontend de la piece busbars_batterie.
...
PIECE_NAME = "busbars_batterie"
TITLE = "Busbars Batterie"
...
def afficher_vues_busbars_batterie(*, data: Mapping[str, Any] | None = None, global_report: Mapping[str, Any] | None = None, run_demo: bool = False) -> Dict[str, Any]:
...
if __name__ == "__main__":
    afficher_vues_busbars_batterie(run_demo=True)
