"""
Chemin : frontend/components/batterie/pieces/bms_batterie/sketches_2d.py
But :
    Produire le contrat de croquis 2D cote de la piece bms_batterie.
...
def tracer_croquis_bms_batterie_2d(data: Mapping[str, Any] | None = None, global_report: Mapping[str, Any] | None = None) -> Any:
    return tracer_croquis(data=data, global_report=global_report)
