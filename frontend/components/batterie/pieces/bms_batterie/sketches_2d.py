...
# frontend/components/batterie/pieces/bms_batterie/sketches_2d.py
from __future__ import annotations

import matplotlib.pyplot as plt
from backend.components.batterie.pieces.bms_batterie import BmsBatterie

def tracer_vue_cote(ax, piece: BmsBatterie):
...
def tracer_vue_face(ax, piece: BmsBatterie):
...
def afficher_2d(piece: BmsBatterie):
