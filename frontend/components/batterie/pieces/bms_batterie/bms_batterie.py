...
But : Page d'affichage (orchestrateur) pour la pièce bms_batterie, utilisant frontend/main.py pour extraire les données.
"""
...
def afficher_vues_bms_batterie():
    ...
    print("Affichage des modules graphiques pour la pièce : bms_batterie")
