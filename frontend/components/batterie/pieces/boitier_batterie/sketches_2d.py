"""
Chemin : frontend/components/batterie/pieces/boitier_batterie/sketches_2d.py
But :
    Produire le contrat de croquis 2D cote de la piece boitier_batterie.
...
def tracer_croquis_boitier_batterie_2d(data: Mapping[str, Any] | None = None, global_report: Mapping[str, Any] | None = None) -> Any:
    return tracer_croquis(data=data, global_report=global_report)
