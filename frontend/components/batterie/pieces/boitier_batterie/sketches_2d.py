...
# frontend/components/batterie/pieces/boitier_batterie/sketches_2d.py
from __future__ import annotations

import matplotlib.pyplot as plt
from backend.components.batterie.pieces.boitier_batterie import BoitierBatterie

def tracer_vue_cote(ax, piece: BoitierBatterie):
...
def tracer_vue_face(ax, piece: BoitierBatterie):
...
def afficher_2d(piece: BoitierBatterie):
