...
But :
    Orchestrer la visualisation frontend de la piece boitier_batterie.
...
PIECE_NAME = "boitier_batterie"
TITLE = "Boitier Batterie"
...
def afficher_vues_boitier_batterie(*, data: Mapping[str, Any] | None = None, global_report: Mapping[str, Any] | None = None, run_demo: bool = False) -> Dict[str, Any]:
...
if __name__ == "__main__":
    afficher_vues_boitier_batterie(run_demo=True)
