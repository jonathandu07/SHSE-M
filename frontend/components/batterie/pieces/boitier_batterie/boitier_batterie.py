...
But : Page d'affichage (orchestrateur) pour la pièce boitier_batterie, utilisant frontend/main.py pour extraire les données.
"""
...
def afficher_vues_boitier_batterie():
    ...
    print("Affichage des modules graphiques pour la pièce : boitier_batterie")
