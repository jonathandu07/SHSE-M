...
# frontend/components/batterie/pieces/tms_batterie/sketches_2d.py
from __future__ import annotations

import matplotlib.pyplot as plt
from backend.components.batterie.pieces.tms_batterie import TmsBatterie

def tracer_vue_cote(ax, piece: TmsBatterie):
...
def tracer_vue_face(ax, piece: TmsBatterie):
...
def afficher_2d(piece: TmsBatterie):
