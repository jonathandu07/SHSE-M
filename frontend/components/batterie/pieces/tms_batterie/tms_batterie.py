...
But : Page d'affichage (orchestrateur) pour la pièce tms_batterie, utilisant frontend/main.py pour extraire les données.
"""
...
def afficher_vues_tms_batterie():
    ...
    print("Affichage des modules graphiques pour la pièce : tms_batterie")
