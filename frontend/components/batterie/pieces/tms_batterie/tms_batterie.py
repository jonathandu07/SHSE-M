"""
Chemin : frontend/components/batterie/pieces/tms_batterie/tms_batterie.py
But : Page d'affichage (orchestrateur) pour la pièce tms_batterie.
"""
...
try:
    ...
    print("Avertissement : Impossible d'importer la classe TmsBatterie du backend.")
...
def afficher_vues_tms_batterie():
    print("=======================================================")
    print("  Affichage des vues pour : tms_batterie")
    print("=======================================================")
    ...
    try:
        ...
        print(f"Erreur lors de l'instanciation de TmsBatterie : {e}")
        return
