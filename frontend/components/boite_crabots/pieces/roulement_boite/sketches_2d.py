...
# frontend/components/boite_crabots/pieces/roulement_boite/sketches_2d.py
from __future__ import annotations

import matplotlib.pyplot as plt
from backend.components.boite_crabots.pieces.roulement_boite import RoulementBoite

def tracer_vue_cote(ax, piece: RoulementBoite):
...
def tracer_vue_face(ax, piece: RoulementBoite):
...
def afficher_2d(piece: RoulementBoite):
