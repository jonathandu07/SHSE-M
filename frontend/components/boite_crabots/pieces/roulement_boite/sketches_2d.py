"""
Chemin : frontend/components/boite_crabots/pieces/roulement_boite/sketches_2d.py
But :
    Produire le contrat de croquis 2D cote de la piece roulement_boite.
...
def tracer_croquis_roulement_boite_2d(data: Mapping[str, Any] | None = None, global_report: Mapping[str, Any] | None = None) -> Any:
    return tracer_croquis(data=data, global_report=global_report)
