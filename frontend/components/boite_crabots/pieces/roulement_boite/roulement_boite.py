...
But :
    Orchestrer la visualisation frontend de la piece roulement_boite.
...
PIECE_NAME = "roulement_boite"
TITLE = "Roulement Boite"
...
def afficher_vues_roulement_boite(*, data: Mapping[str, Any] | None = None, global_report: Mapping[str, Any] | None = None, run_demo: bool = False) -> Dict[str, Any]:
...
if __name__ == "__main__":
    afficher_vues_roulement_boite(run_demo=True)
