...
But : Page d'affichage (orchestrateur) pour la pièce roulement_boite.
"""
...
try:
    ...
    print("Avertissement : Impossible d'importer la classe RoulementBoite du backend.")
...
def afficher_vues_roulement_boite():
    print("=======================================================")
    print("  Affichage des vues pour : roulement_boite")
    print("=======================================================")
    ...
    try:
        piece = RoulementBoite()
    except Exception as e:
        print(f"Erreur lors de l'instanciation de RoulementBoite : {e}")
        return
