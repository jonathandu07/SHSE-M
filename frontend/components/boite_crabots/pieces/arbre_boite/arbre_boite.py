...
But : Page d'affichage (orchestrateur) pour la pièce arbre_boite, utilisant frontend/main.py pour extraire les données.
"""
...
def afficher_vues_arbre_boite():
    ...
    print("Affichage des modules graphiques pour la pièce : arbre_boite")
