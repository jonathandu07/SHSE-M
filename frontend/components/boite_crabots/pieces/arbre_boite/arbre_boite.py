"""
Chemin : frontend/components/boite_crabots/pieces/arbre_boite/arbre_boite.py
But : Page d'affichage (orchestrateur) pour la pièce arbre_boite.
"""
...
try:
    ...
    print("Avertissement : Impossible d'importer la classe ArbreBoite du backend.")
...
def afficher_vues_arbre_boite():
    print("=======================================================")
    print("  Affichage des vues pour : arbre_boite")
    print("=======================================================")
    ...
    try:
        ...
        print(f"Erreur lors de l'instanciation de ArbreBoite : {e}")
        return
