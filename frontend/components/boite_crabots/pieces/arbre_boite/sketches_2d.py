...
# frontend/components/boite_crabots/pieces/arbre_boite/sketches_2d.py
from __future__ import annotations

import matplotlib.pyplot as plt
from backend.components.boite_crabots.pieces.arbre_boite import ArbreBoite

def tracer_vue_cote(ax, piece: ArbreBoite):
...
def tracer_vue_face(ax, piece: ArbreBoite):
...
def afficher_2d(piece: ArbreBoite):
