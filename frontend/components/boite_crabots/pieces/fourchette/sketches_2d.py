...
# frontend/components/boite_crabots/pieces/fourchette/sketches_2d.py
from __future__ import annotations

import matplotlib.pyplot as plt
from backend.components.boite_crabots.pieces.fourchette import Fourchette

def tracer_vue_cote(ax, piece: Fourchette):
...
def tracer_vue_face(ax, piece: Fourchette):
...
def afficher_2d(piece: Fourchette):
