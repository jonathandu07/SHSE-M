"""
Chemin : frontend/components/boite_crabots/pieces/fourchette/mesh_3d.py
But : Définition et génération du maillage 3D pour la modélisation de la pièce.
"""

# frontend/components/boite_crabots/pieces/fourchette/mesh_3d.py
from __future__ import annotations

import pyvista as pv
from backend.components.boite_crabots.pieces.fourchette import Fourchette

def construire_mesh(piece: Fourchette) -> pv.PolyData:
    """Construit le maillage 3D de la pièce."""
    # TODO: Remplacer par la géométrie exacte
    mesh = pv.Cube() 
    return mesh

def afficher_3d(piece: Fourchette, afficher_axes: bool = True):
