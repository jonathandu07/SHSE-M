"""
Chemin : frontend/components/boite_crabots/pieces/fourchette/charts.py
But : Génération des graphiques et visualisations de données pour la pièce.
"""

# frontend/components/boite_crabots/pieces/fourchette/charts.py
...
def afficher_radar(piece: Fourchette):
