...
But : Page d'affichage (orchestrateur) pour la pièce fourchette, utilisant frontend/main.py pour extraire les données.
"""
...
def afficher_vues_fourchette():
    ...
    print("Affichage des modules graphiques pour la pièce : fourchette")
