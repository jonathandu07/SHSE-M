"""
Chemin : frontend/components/boite_crabots/pieces/fourchette/fourchette.py
But : Page d'affichage (orchestrateur) pour la pièce fourchette.
"""
...
try:
    ...
    print("Avertissement : Impossible d'importer la classe Fourchette du backend.")
...
def afficher_vues_fourchette():
    print("=======================================================")
    print("  Affichage des vues pour : fourchette")
    print("=======================================================")
    ...
    try:
        ...
        print(f"Erreur lors de l'instanciation de Fourchette : {e}")
        return
