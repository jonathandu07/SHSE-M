"""
Chemin : frontend/components/boite_crabots/pieces/pignon_boite/sketches_2d.py
But : Définition des esquisses géométriques 2D de la pièce.
"""

# frontend/components/boite_crabots/pieces/pignon_boite/sketches_2d.py
from __future__ import annotations

import matplotlib.pyplot as plt
from backend.components.boite_crabots.pieces.pignon_boite import PignonBoite

def tracer_vue_cote(ax, piece: PignonBoite):
...
def tracer_vue_face(ax, piece: PignonBoite):
...
def afficher_2d(piece: PignonBoite):
