"""
Chemin : frontend/components/boite_crabots/pieces/pignon_boite/pignon_boite.py
But : Page d'affichage (orchestrateur) pour la pièce pignon_boite.
"""
...
try:
    ...
    print("Avertissement : Impossible d'importer la classe PignonBoite du backend.")
...
def afficher_vues_pignon_boite():
    print("=======================================================")
    print("  Affichage des vues pour : pignon_boite")
    print("=======================================================")
    ...
    try:
        ...
        print(f"Erreur lors de l'instanciation de PignonBoite : {e}")
        return
