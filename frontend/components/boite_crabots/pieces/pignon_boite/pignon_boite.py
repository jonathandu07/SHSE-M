...
But : Page d'affichage (orchestrateur) pour la pièce pignon_boite, utilisant frontend/main.py pour extraire les données.
"""
...
def afficher_vues_pignon_boite():
    ...
    print("Affichage des modules graphiques pour la pièce : pignon_boite")
