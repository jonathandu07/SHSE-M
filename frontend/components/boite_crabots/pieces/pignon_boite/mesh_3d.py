# frontend/components/boite_crabots/pieces/pignon_boite/mesh_3d.py
from __future__ import annotations

import pyvista as pv
from backend.components.boite_crabots.pieces.pignon_boite import PignonBoite

def construire_mesh(piece: PignonBoite) -> pv.PolyData:
    """Construit le maillage 3D de la pièce."""
    # TODO: Remplacer par la géométrie exacte
    mesh = pv.Cube() 
    return mesh

def afficher_3d(piece: PignonBoite, afficher_axes: bool = True):
