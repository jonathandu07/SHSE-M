"""
Chemin : frontend/components/boite_crabots/pieces/pignon_boite/charts.py
But : Génération des graphiques et visualisations de données pour la pièce.
"""

# frontend/components/boite_crabots/pieces/pignon_boite/charts.py
...
def afficher_radar(piece: PignonBoite):
