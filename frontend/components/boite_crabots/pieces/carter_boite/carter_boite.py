...
But : Page d'affichage (orchestrateur) pour la pièce carter_boite, utilisant frontend/main.py pour extraire les données.
"""
...
def afficher_vues_carter_boite():
    ...
    print("Affichage des modules graphiques pour la pièce : carter_boite")
