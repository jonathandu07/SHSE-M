"""
Chemin : frontend/components/boite_crabots/pieces/carter_boite/carter_boite.py
But : Page d'affichage (orchestrateur) pour la pièce carter_boite.
"""
...
try:
    ...
    print("Avertissement : Impossible d'importer la classe CarterBoite du backend.")
...
def afficher_vues_carter_boite():
    print("=======================================================")
    print("  Affichage des vues pour : carter_boite")
    print("=======================================================")
    ...
    try:
        ...
        print(f"Erreur lors de l'instanciation de CarterBoite : {e}")
        return
