...
# frontend/components/boite_crabots/pieces/carter_boite/sketches_2d.py
from __future__ import annotations

import matplotlib.pyplot as plt
from backend.components.boite_crabots.pieces.carter_boite import CarterBoite

def tracer_vue_cote(ax, piece: CarterBoite):
...
def tracer_vue_face(ax, piece: CarterBoite):
...
def afficher_2d(piece: CarterBoite):
