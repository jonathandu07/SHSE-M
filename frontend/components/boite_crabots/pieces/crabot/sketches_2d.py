"""
Chemin : frontend/components/boite_crabots/pieces/crabot/sketches_2d.py
But : Définition des esquisses géométriques 2D de la pièce.
"""

# frontend/components/boite_crabots/pieces/crabot/sketches_2d.py
from __future__ import annotations

import matplotlib.pyplot as plt
from backend.components.boite_crabots.pieces.crabot import Crabot

def tracer_vue_cote(ax, piece: Crabot):
...
def tracer_vue_face(ax, piece: Crabot):
