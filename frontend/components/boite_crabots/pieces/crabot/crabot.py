...
But : Page d'affichage (orchestrateur) pour la pièce crabot, utilisant frontend/main.py pour extraire les données.
"""
...
def afficher_vues_crabot():
    ...
    print("Affichage des modules graphiques pour la pièce : crabot")
