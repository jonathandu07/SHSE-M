"""
Chemin : frontend/components/boite_crabots/pieces/crabot/crabot.py
But : Page d'affichage (orchestrateur) pour la pièce crabot.
"""
...
try:
    from backend.components.boite_crabots.pieces.crabot import Crabot
    HAS_BACKEND_CLASS = True
except ImportError:
    HAS_BACKEND_CLASS = False
    print("Avertissement : Impossible d'importer la classe Crabot du backend.")
...
def afficher_vues_crabot():
    print("=======================================================")
    print("  Affichage des vues pour : crabot")
    print("=======================================================")
    ...
    try:
        ...
        print(f"Erreur lors de l'instanciation de Crabot : {e}")
        return
