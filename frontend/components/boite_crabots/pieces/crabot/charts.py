"""
Chemin : frontend/components/boite_crabots/pieces/crabot/charts.py
But : Génération des graphiques et visualisations de données pour la pièce.
"""

# frontend/components/boite_crabots/pieces/crabot/charts.py
...
def afficher_radar(piece: Crabot):
