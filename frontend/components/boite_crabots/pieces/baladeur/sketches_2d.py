"""
Chemin : frontend/components/boite_crabots/pieces/baladeur/sketches_2d.py
But : Définition des esquisses géométriques 2D de la pièce.
"""

# frontend/components/boite_crabots/pieces/baladeur/sketches_2d.py
from __future__ import annotations

import matplotlib.pyplot as plt
from backend.components.boite_crabots.pieces.baladeur import Baladeur

def tracer_vue_cote(ax, piece: Baladeur):
...
def tracer_vue_face(ax, piece: Baladeur):
...
def afficher_2d(piece: Baladeur):
