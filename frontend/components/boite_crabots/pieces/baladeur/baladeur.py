...
But : Page d'affichage (orchestrateur) pour la pièce baladeur, utilisant frontend/main.py pour extraire les données.
"""
...
def afficher_vues_baladeur():
    ...
    print("Affichage des modules graphiques pour la pièce : baladeur")
