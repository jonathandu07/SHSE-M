"""
Chemin : frontend/components/boite_crabots/pieces/baladeur/baladeur.py
But : Page d'affichage (orchestrateur) pour la pièce baladeur.
"""
...
try:
    ...
    print("Avertissement : Impossible d'importer la classe Baladeur du backend.")
...
def afficher_vues_baladeur():
    print("=======================================================")
    print("  Affichage des vues pour : baladeur")
    print("=======================================================")
    ...
    try:
        ...
        print(f"Erreur lors de l'instanciation de Baladeur : {e}")
        return
