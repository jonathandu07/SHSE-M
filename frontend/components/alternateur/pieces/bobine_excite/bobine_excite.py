...
But : Page d'affichage (orchestrateur) pour la pièce bobine_excite, utilisant frontend/main.py pour extraire les données.
"""
...
def afficher_vues_bobine_excite():
    ...
    print("Affichage des modules graphiques pour la pièce : bobine_excite")
