"""
Chemin : frontend/components/alternateur/pieces/bobine_excite/bobine_excite.py
But : Page d'affichage (orchestrateur) pour la pièce bobine_excite.
"""
...
try:
    ...
    print("Avertissement : Impossible d'importer la classe BobineExcite du backend.")
...
def afficher_vues_bobine_excite():
    print("=======================================================")
    print("  Affichage des vues pour : bobine_excite")
    print("=======================================================")
    ...
    try:
        ...
        print(f"Erreur lors de l'instanciation de BobineExcite : {e}")
        return
