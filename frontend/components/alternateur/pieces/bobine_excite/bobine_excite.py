...
But :
    Orchestrer la visualisation frontend de la piece bobine_excite.
...
def afficher_vues_bobine_excite(*, data: Mapping[str, Any] | None = None, global_report: Mapping[str, Any] | None = None, run_demo: bool = False) -> Dict[str, Any]:
...
if __name__ == "__main__":
    afficher_vues_bobine_excite(run_demo=True)
