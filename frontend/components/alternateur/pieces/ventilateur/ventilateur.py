"""
Chemin : frontend/components/alternateur/pieces/ventilateur/ventilateur.py
But : Page d'affichage (orchestrateur) pour la pièce ventilateur.
"""
...
try:
    ...
    print("Avertissement : Impossible d'importer la classe Ventilateur du backend.")
...
def afficher_vues_ventilateur():
    print("=======================================================")
    print("  Affichage des vues pour : ventilateur")
    print("=======================================================")
    ...
    try:
        ...
        print(f"Erreur lors de l'instanciation de Ventilateur : {e}")
        return
