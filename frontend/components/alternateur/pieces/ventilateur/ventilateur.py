...
But : Page d'affichage (orchestrateur) pour la pièce ventilateur, utilisant frontend/main.py pour extraire les données.
"""
...
def afficher_vues_ventilateur():
    ...
    print("Affichage des modules graphiques pour la pièce : ventilateur")
