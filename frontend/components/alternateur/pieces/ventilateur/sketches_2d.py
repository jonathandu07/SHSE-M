...
# frontend/components/alternateur/pieces/ventilateur/sketches_2d.py
from __future__ import annotations

import matplotlib.pyplot as plt
from backend.components.alternateur.pieces.ventilateur import Ventilateur

def tracer_vue_cote(ax, piece: Ventilateur):
...
def tracer_vue_face(ax, piece: Ventilateur):
...
def afficher_2d(piece: Ventilateur):
