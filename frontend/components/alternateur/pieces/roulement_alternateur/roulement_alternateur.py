"""
Chemin : frontend/components/alternateur/pieces/roulement_alternateur/roulement_alternateur.py
But : Page d'affichage (orchestrateur) pour la pièce roulement_alternateur.
"""
...
try:
    ...
    print("Avertissement : Impossible d'importer la classe RoulementAlternateur du backend.")
...
def afficher_vues_roulement_alternateur():
    print("=======================================================")
    print("  Affichage des vues pour : roulement_alternateur")
    print("=======================================================")
    ...
    try:
        piece = RoulementAlternateur()
    except Exception as e:
        print(f"Erreur lors de l'instanciation de RoulementAlternateur : {e}")
        return
...
if __name__ == "__main__":
    afficher_vues_roulement_alternateur()
