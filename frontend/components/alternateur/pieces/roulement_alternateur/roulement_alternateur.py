...
But :
    Orchestrer la visualisation frontend de la piece roulement_alternateur.
...
PIECE_NAME = "roulement_alternateur"
TITLE = "Roulement Alternateur"
...
def afficher_vues_roulement_alternateur(*, data: Mapping[str, Any] | None = None, global_report: Mapping[str, Any] | None = None, run_demo: bool = False) -> Dict[str, Any]:
...
if __name__ == "__main__":
    afficher_vues_roulement_alternateur(run_demo=True)
