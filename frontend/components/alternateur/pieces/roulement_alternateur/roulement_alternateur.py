...
But : Page d'affichage (orchestrateur) pour la pièce roulement_alternateur, utilisant frontend/main.py pour extraire les données.
"""
...
def afficher_vues_roulement_alternateur():
    ...
    print("Affichage des modules graphiques pour la pièce : roulement_alternateur")
