"""
Chemin : frontend/components/alternateur/pieces/roulement_alternateur/render_contract.py
But :
    Fournir le contrat de rendu commun de la piece roulement_alternateur.
