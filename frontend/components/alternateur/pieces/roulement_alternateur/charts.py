"""
Chemin : frontend/components/alternateur/pieces/roulement_alternateur/charts.py
But :
    Exposer les graphiques backend de comportement pour la piece roulement_alternateur.
