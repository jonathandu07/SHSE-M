...
# frontend/components/alternateur/pieces/roulement_alternateur/sketches_2d.py
from __future__ import annotations

import matplotlib.pyplot as plt
from backend.components.alternateur.pieces.roulement_alternateur import RoulementAlternateur

def tracer_vue_cote(ax, piece: RoulementAlternateur):
...
def tracer_vue_face(ax, piece: RoulementAlternateur):
...
def afficher_2d(piece: RoulementAlternateur):
