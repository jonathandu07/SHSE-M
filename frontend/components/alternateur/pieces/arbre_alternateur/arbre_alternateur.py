"""
Chemin : frontend/components/alternateur/pieces/arbre_alternateur/arbre_alternateur.py
But : Page d'affichage (orchestrateur) pour la pièce arbre_alternateur.
"""
...
try:
    ...
    print("Avertissement : Impossible d'importer la classe ArbreAlternateur du backend.")
...
def afficher_vues_arbre_alternateur():
    print("=======================================================")
    print("  Affichage des vues pour : arbre_alternateur")
    print("=======================================================")
    ...
    try:
        piece = ArbreAlternateur()
    except Exception as e:
        print(f"Erreur lors de l'instanciation de ArbreAlternateur : {e}")
        return
...
if __name__ == "__main__":
    afficher_vues_arbre_alternateur()
