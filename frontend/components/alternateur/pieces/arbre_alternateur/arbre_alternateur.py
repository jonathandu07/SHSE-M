...
But : Page d'affichage (orchestrateur) pour la pièce arbre_alternateur, utilisant frontend/main.py pour extraire les données.
"""
...
def afficher_vues_arbre_alternateur():
    ...
    print("Affichage des modules graphiques pour la pièce : arbre_alternateur")
