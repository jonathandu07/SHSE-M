...
But :
    Orchestrer la visualisation frontend de la piece arbre_alternateur.
...
PIECE_NAME = "arbre_alternateur"
TITLE = "Arbre Alternateur"
...
def afficher_vues_arbre_alternateur(*, data: Mapping[str, Any] | None = None, global_report: Mapping[str, Any] | None = None, run_demo: bool = False) -> Dict[str, Any]:
...
if __name__ == "__main__":
    afficher_vues_arbre_alternateur(run_demo=True)
