"""
Chemin : frontend/components/alternateur/pieces/arbre_alternateur/sketches_2d.py
But :
    Produire le contrat de croquis 2D cote de la piece arbre_alternateur.
...
def tracer_croquis_arbre_alternateur_2d(data: Mapping[str, Any] | None = None, global_report: Mapping[str, Any] | None = None) -> Any:
    return tracer_croquis(data=data, global_report=global_report)
