...
# frontend/components/alternateur/pieces/arbre_alternateur/sketches_2d.py
from __future__ import annotations

import matplotlib.pyplot as plt
from backend.components.alternateur.pieces.arbre_alternateur import ArbreAlternateur

def tracer_vue_cote(ax, piece: ArbreAlternateur):
...
def tracer_vue_face(ax, piece: ArbreAlternateur):
...
def afficher_2d(piece: ArbreAlternateur):
