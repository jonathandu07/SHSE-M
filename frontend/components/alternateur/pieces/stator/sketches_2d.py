...
# frontend/components/alternateur/pieces/stator/sketches_2d.py
from __future__ import annotations

import matplotlib.pyplot as plt
from backend.components.alternateur.pieces.stator import Stator

def tracer_vue_cote(ax, piece: Stator):
...
def tracer_vue_face(ax, piece: Stator):
