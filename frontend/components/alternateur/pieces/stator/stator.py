"""
Chemin : frontend/components/alternateur/pieces/stator/stator.py
But : Page d'affichage (orchestrateur) pour la pièce stator.
"""
...
try:
    ...
    print("Avertissement : Impossible d'importer la classe Stator du backend.")
...
def afficher_vues_stator():
    print("=======================================================")
    print("  Affichage des vues pour : stator")
    print("=======================================================")
    ...
    try:
        ...
        print(f"Erreur lors de l'instanciation de Stator : {e}")
        return
