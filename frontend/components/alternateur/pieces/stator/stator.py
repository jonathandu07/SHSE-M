...
But : Page d'affichage (orchestrateur) pour la pièce stator, utilisant frontend/main.py pour extraire les données.
"""
...
def afficher_vues_stator():
    ...
    print("Affichage des modules graphiques pour la pièce : stator")
