...
# frontend/components/alternateur/pieces/rotor/sketches_2d.py
from __future__ import annotations

import matplotlib.pyplot as plt
from backend.components.alternateur.pieces.rotor import Rotor

def tracer_vue_cote(ax, piece: Rotor):
...
def tracer_vue_face(ax, piece: Rotor):
