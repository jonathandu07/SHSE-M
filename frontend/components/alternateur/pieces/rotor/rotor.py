...
But : Page d'affichage (orchestrateur) pour la pièce rotor, utilisant frontend/main.py pour extraire les données.
"""
...
def afficher_vues_rotor():
    ...
    print("Affichage des modules graphiques pour la pièce : rotor")
