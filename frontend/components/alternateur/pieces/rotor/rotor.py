"""
Chemin : frontend/components/alternateur/pieces/rotor/rotor.py
But : Page d'affichage (orchestrateur) pour la pièce rotor.
"""
...
try:
    ...
    print("Avertissement : Impossible d'importer la classe Rotor du backend.")
...
def afficher_vues_rotor():
    print("=======================================================")
    print("  Affichage des vues pour : rotor")
    print("=======================================================")
    ...
    try:
        ...
        print(f"Erreur lors de l'instanciation de Rotor : {e}")
        return
