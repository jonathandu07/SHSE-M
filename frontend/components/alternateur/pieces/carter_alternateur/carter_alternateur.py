"""
Chemin : frontend/components/alternateur/pieces/carter_alternateur/carter_alternateur.py
But : Page d'affichage (orchestrateur) pour la pièce carter_alternateur.
"""
...
try:
    ...
    print("Avertissement : Impossible d'importer la classe CarterAlternateur du backend.")
...
def afficher_vues_carter_alternateur():
    print("=======================================================")
    print("  Affichage des vues pour : carter_alternateur")
    print("=======================================================")
    ...
    try:
        piece = CarterAlternateur()
    except Exception as e:
        print(f"Erreur lors de l'instanciation de CarterAlternateur : {e}")
        return
...
if __name__ == "__main__":
    afficher_vues_carter_alternateur()
