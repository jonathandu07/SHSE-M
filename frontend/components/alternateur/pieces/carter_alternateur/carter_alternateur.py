...
But : Page d'affichage (orchestrateur) pour la pièce carter_alternateur, utilisant frontend/main.py pour extraire les données.
"""
...
def afficher_vues_carter_alternateur():
    ...
    print("Affichage des modules graphiques pour la pièce : carter_alternateur")
