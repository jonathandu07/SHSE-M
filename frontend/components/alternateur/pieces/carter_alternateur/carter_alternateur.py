...
But :
    Orchestrer la visualisation frontend de la piece carter_alternateur.
...
PIECE_NAME = "carter_alternateur"
TITLE = "Carter Alternateur"
...
def afficher_vues_carter_alternateur(*, data: Mapping[str, Any] | None = None, global_report: Mapping[str, Any] | None = None, run_demo: bool = False) -> Dict[str, Any]:
...
if __name__ == "__main__":
    afficher_vues_carter_alternateur(run_demo=True)
