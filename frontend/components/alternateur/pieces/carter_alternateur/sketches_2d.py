...
# frontend/components/alternateur/pieces/carter_alternateur/sketches_2d.py
from __future__ import annotations

import matplotlib.pyplot as plt
from backend.components.alternateur.pieces.carter_alternateur import CarterAlternateur

def tracer_vue_cote(ax, piece: CarterAlternateur):
...
def tracer_vue_face(ax, piece: CarterAlternateur):
...
def afficher_2d(piece: CarterAlternateur):
