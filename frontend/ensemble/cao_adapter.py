...
def build_cao_frontend_summary(report: Mapping[str, Any]) -> Dict[str, Any]:
    ...
    return {
        ...
        "sketches_available": bool(croquis),
        "views_3d_available": bool(vues),
        "stress_graphs_available": bool(graphs),
        "drawing_data_available": bool(dossier.get("donnees_solidworks") or dossier.get("pieces")),
