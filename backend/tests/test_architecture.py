...
class TestArchitecture(unittest.TestCase):
    ...
    def test_cylindree_totale(self):
        ...
        v_tot = calcul_cylindree_totale_requise(100000, 10e5, 25, 1.0) 
    ...
    def test_cout_maintenance_estime(self):
        c1 = calcul_cout_maintenance_estime(5000, 5000, 1000, 1000, 1, 1, 100)
        self.assertAlmostEqual(c1, 100.0)
        
        c2 = calcul_cout_maintenance_estime(5000, 5000, 1000, 500, 1, 1, 100)
        self.assertLess(c2, c1)

    def test_resolution_globale(self):
        res = resoudre_architecture_globale(50000, 3000, 10e5, 20, 2.0, 2.0)
